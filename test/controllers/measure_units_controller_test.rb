...
class MeasureUnitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create measure_unit" do
    assert_difference('MeasureUnit.count') do
      post measure_units_url, params: { measure_unit: { name: @measure_unit.name, unit_type: @measure_unit.unit_type } }
    end
  ...
  test "should update measure_unit" do
    patch measure_unit_url(@measure_unit), params: { measure_unit: { name: @measure_unit.name, unit_type: @measure_unit.unit_type } }
