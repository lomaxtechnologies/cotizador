const CONFIRM_DELETE_BRAND_TITLE = '¿Realmente deseas eliminiar a esta marca?';
const CONFIRM_DELETE_BRAND_BODY = `
...
`;
const CONFIRM_DELETE_BRAND_YES_TEXT = 'Sí, elimínala';
const CONFIRM_DELETE_BRAND_NO_TEXT = 'Cancelar';
