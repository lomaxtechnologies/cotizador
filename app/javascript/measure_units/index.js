const CONFIRM_DELETE_USER_TITLE = '¿Realmente deseas eliminiar a esta unidad de material?';
const CONFIRM_DELETE_USER_BODY = `
   Una vez eliminada no podrás recuperarla y deberás crear una nueva. 
   Todas la información asociada a esta unidad de material (productos, precios, etc.) seguirá existiendo.
`;
