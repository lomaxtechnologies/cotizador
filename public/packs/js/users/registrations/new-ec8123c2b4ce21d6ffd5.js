...
/* WEBPACK VAR INJECTION */(function($) {window.confirm_password = function (element) {
  ...
  if (password && password_confirmation) {
    if (password_confirmation != password) {
      password_element.setCustomValidity('Las contraseñas no coinciden.');
    } else {
      password_element.setCustomValidity('');
    }
  }
};
...
/******/ });
//# sourceMappingURL=new-ec8123c2b4ce21d6ffd5.js.map