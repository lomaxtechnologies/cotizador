...
/* WEBPACK VAR INJECTION */(function($) {window.confirm_password = function (element) {
  ...
  var password_confirmation_element = $("#".concat(password_element.attr('cofirmation')));
  password = password_element.val();
  password_confirmation = password_confirmation_element.val();

  if (password && password_confirmation) {
    this.console.log('hola mundo');

    if (password_confirmation != password) {
      password_element[0].setCustomValidity('Las contraseñas no coinciden.');
    }
  }
};
...
/******/ });
//# sourceMappingURL=new-c81917ad040678708270.js.map