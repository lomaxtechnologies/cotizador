...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var vue_turbolinks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue-turbolinks */ "./node_modules/vue-turbolinks/index.js");
...
var app = new vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  data: {
    quotation_type: 1,
    valid_header: false,
    siemon_disabled: false,
    supranet_disabled: false
  },
  methods: {
    block_siemon: function block_siemon() {
      this.siemon_disabled = !this.siemon_disabled;
    },
    block_supranet: function block_supranet() {
      this.supranet_disabled = !this.supranet_disabled;
    },
    validate_header: function validate_header() {
      $('#nav-link-header').removeClass('text-muted').addClass('text-success');
      this.valid_header = true;
    },
    invalidate_header: function invalidate_header() {
...
/******/ });
//# sourceMappingURL=header-dffb1062f9ded1bffaf3.js.map