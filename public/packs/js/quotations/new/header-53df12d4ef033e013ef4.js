...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(jQuery) {/* harmony import */ var vue_turbolinks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue-turbolinks */ "./node_modules/vue-turbolinks/index.js");
...
var app = new vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  methods: {
    validate_header: function validate_header() {
      if (jQuery('#quotation_header_form').valid()) {
        console.log('yes!');
      } else {
        console.log('no');
      }
...
/******/ });
//# sourceMappingURL=header-53df12d4ef033e013ef4.js.map