...
vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_1__["default"].use({
...
var app = new vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  methods: {
    validate_header: function validate_header() {
      console.log($('#quotation_header_form').html());

      if ($('#quotation_header_form').valid()) {
        console.log('yes!');
      } else {
        console.log('no');
      }
...
/******/ });
//# sourceMappingURL=header-35fc50b9169b27ad0950.js.map