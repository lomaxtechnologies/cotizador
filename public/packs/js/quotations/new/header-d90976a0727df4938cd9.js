...
var app = new vue_dist_vue_esm__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  methods: {
    validate_header: function validate_header() {
      console.log('verificando validacion');

      if ($('#quotation_header_form')[0].checkValidity()) {
        this.header_valid = true;
      } else {
        this.header_valid = false;
      }
    }
  },
...
/******/ });
//# sourceMappingURL=header-d90976a0727df4938cd9.js.map